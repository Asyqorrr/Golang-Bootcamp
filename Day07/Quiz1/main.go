...
import (
	models "day07/practise02/quiz1/models"
	"fmt"
	"time"
)
...
func main() {
	...
	employees := []models.Employee{prog1.Employee, prog2.Employee, prog3.Employee, prog4.Employee, sales1.Employee, qa1.Employee}
	...
	fmt.Printf("Profession of %s is %s\n\n", prog1.GetName(), prog1.GetProfession())
